...
public class JDBCZeusFilterDao implements IZeusFilterDao {
	private static final Logger LOGGER = LoggerFactory.getLogger(JDBCZeusFilterDao.class);
	private String filterTable;
	private HikariDataSource dataSource;
	private String applicationName;
	private String SQL;

	public JDBCZeusFilterDao(String filterTable, HikariDataSource dataSource, String applicationName) {
