...
public class ZeusCommandHelper {
    public static int getSemaphoreMaxConcurrent(String commandGroup, String commandKey) {
        ...
        if (maxConcurrent == 0) {
            maxConcurrent = DynamicPropertyFactory.getInstance().getIntProperty("zeus.semaphore.max.global", 100).get();
        }
    ...
    public static int getThreadTimeout(String commandGroup, String commandKey) {
        ...
        if (timeout == 0) {
            timeout = DynamicPropertyFactory.getInstance().getIntProperty("zeus.thread.timeout.global", 1500).get();
        }
        return timeout;
    }
    ...
    public static boolean getCircuitBreakerEnabled(String commandGroup, String commandKey) {
        ...
        if (bool == null) {
            bool = DynamicPropertyFactory.getInstance().getStringProperty("zeus.circuit-breaker.enabled.global", "true").get();
        }
    ...
    public static boolean getCircuitBreakerForceOpen(String commandGroup, String commandKey) {
        ...
        if (bool == null) {
            bool = DynamicPropertyFactory.getInstance().getStringProperty("zeus.circuit-breaker.force-open.global", "false").get();
        }
        return bool.toString().equalsIgnoreCase("true");
    }
    ...
    public static boolean getCircuitBreakerForceClosed(String commandGroup, String commandKey) {
        ...
        if (bool == null) {
            bool = DynamicPropertyFactory.getInstance().getStringProperty("zeus.circuit-breaker.force-closed.global", "false").get();
        }
        return bool.toString().equalsIgnoreCase("true");
    }
    ...
    public static int getCircuitBreakerRequestThreshold(String commandGroup, String commandKey) {
        ...
        if (i == 0) {
            i = DynamicPropertyFactory.getInstance().getIntProperty("zeus.circuit-breaker.request-threshold.global", 10).get();
        }
        return i;
    }
    ...
    public static int getCircuitBreakerErrorThreshold(String commandGroup, String commandKey) {
        ...
        if (i == 0) {
            i = DynamicPropertyFactory.getInstance().getIntProperty("zeus.circuit-breaker.error-percentage.global", 30).get();
        }
        return i;
    }
    ...
    public static int getCircuitBreakerSleep(String commandGroup, String commandKey) {
        ...
        if (i == 0) {
            i = DynamicPropertyFactory.getInstance().getIntProperty("zeus.circuit-breaker.sleep.global", 10000).get();
        }
        return i;
    }
    ...
    public static int getThreadPoolSize(String threadPoolKey) {
        ...
        if (i == 0) {
            i = DynamicPropertyFactory.getInstance().getIntProperty("zeus.hystrix.thread-pool.size.global", 10).get();
        }
        return i;
    }
    ...
    public static int getRibbonConnectTimeout(String groupName, String routeName) {
		...
		if (connectTimeout == 0) {
			connectTimeout = DynamicPropertyFactory.getInstance().getIntProperty("zeus.connect.timeout.global", 20000)
					.get();
		}
    ...
    public static int  getRibbonReadTimeout(String groupName, String routeName) {
		...
		if (socketTimeout == 0) {
			socketTimeout = DynamicPropertyFactory.getInstance().getIntProperty("zeus.socket.timeout.global", 10000)
					.get();
		}
    ...
    public static boolean getRibbonRequestSpecificRetryOn(String groupName, String routeName) {
		...
		if (!nextTry) {
			nextTry = DynamicPropertyFactory.getInstance().getBooleanProperty("zeus.socket.next.try.global", true).get();
		}
		return nextTry;
    }
    ...
    public static boolean getRibbonOkToRetryOnAllOperations(String groupName, String routeName) {
		...
		if (!sameTry) {
			sameTry = DynamicPropertyFactory.getInstance().getBooleanProperty("zeus.socket.same.try.global", true).get();
		}
		return sameTry;
    }
}