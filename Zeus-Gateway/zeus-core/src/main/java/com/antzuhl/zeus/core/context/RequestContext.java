package com.antzuhl.zeus.core.context;

import com.antzuhl.zeus.core.common.ZeusHeaders;
import com.antzuhl.zeus.core.util.DeepCopy;
...
/**
 * The Request Context holds request, response,  state information and data for Zeus to access and share.
...
public class RequestContext extends ConcurrentHashMap<String, Object> {
	...
	/**
	 * true if ZeusEngineRan
	 *
	 * @return
	 */
	public boolean getZeusEngineRan() {
		return getBoolean("zeusEngineRan");
	}

	/**
	 * sets zeusEngineRan to true
	 */
	public void setZeusEngineRan() {
		put("zeusEngineRan", true);
	}
    ...
    /**
     * returns the "route". This is a zeus defined bucket for collecting request metrics. By default the route is the
	 ...
	 * to the client.
	 * <p>
	 * It is almost generated by zeus gateway, Eq. static resource or the error
	 ...
	 * @return
	 */
	public boolean sendZeusResponse() {
		return getBoolean("sendZeusResponse", true);
	}

	/**
	 * sets the sendZeusResponse boolean
	 *
	 * @param bSend
	 */
	public void setSendZeusResponse(boolean bSend) {
		set("sendZeusResponse", Boolean.valueOf(bSend));
	}
	 ...
	 * @param value
	 */
	public void addZeusRequestHeader(String name, String value) {
		getZeusRequestHeaders().put(name.toLowerCase(), value);
	}
	 ...
	 * @return the list of requestHeaders to be sent to the origin
	 */
	public Map<String, String> getZeusRequestHeaders() {
		if (get("zeusRequestHeaders") == null) {
			HashMap<String, String> zeusRequestHeaders = new HashMap<String, String>();
			putIfAbsent("zeusRequestHeaders", zeusRequestHeaders);
		}
		return (Map<String, String>) get("zeusRequestHeaders");
	}
	 ...
	 * @param value
	 */
	public void addZeusResponseHeader(String name, String value) {
		getZeusResponseHeaders().add(new Pair<String, String>(name, value));
	}
	 ...
	 */
	public List<Pair<String, String>> getZeusResponseHeaders() {
		if (get("zeusResponseHeaders") == null) {
			List<Pair<String, String>> zeusRequestHeaders = new ArrayList<Pair<String, String>>();
			putIfAbsent("zeusResponseHeaders", zeusRequestHeaders);
		}
		return (List<Pair<String, String>>) get("zeusResponseHeaders");
	}
	...
	public boolean isGzipRequested() {
		final String requestEncoding = this.getRequest().getHeader(ZeusHeaders.ACCEPT_ENCODING);
