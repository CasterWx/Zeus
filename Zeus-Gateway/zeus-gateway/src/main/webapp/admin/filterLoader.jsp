<%@ page import="com.antzuhl.zeus.core.common.FilterInfo" %>
<%@ page import="com.antzuhl.zeus.core.common.IZeusFilterDao" %>
<%@ page import="com.antzuhl.zeus.core.filters.ZeusFilterDaoFactory" %>
<%@ page import="com.antzuhl.zeus.core.util.AdminFilterUtil" %>
...
<%
    ...
    IZeusFilterDao scriptDAO = null;
    try {
        scriptDAO = ZeusFilterDaoFactory.getZeusFilterDao();
    } catch (Exception e) {
...
<html>
<head>
    <title>Zeus Filter Manager</title>
</head>
<body>
...
<table border="1">
    ...
    <%
        ...
        for (String filterID : filterIds) {
            filters = scriptDAO.getZeusFilters(filterID);
            for (FilterInfo filter : filters) {
    %>
    <tr>
        <td><%=filter.getFilterName()%>
